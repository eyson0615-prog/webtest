...
export const DollarIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 16v-1m0-1c-1.11 0-2.08-.402-2.599-1M12 16c-1.657 0-3-.895-3-2s1.343-2 3-2m0 8v1m0-1c1.657 0 3-.895 3-2s-1.343-2-3-2m-3 4h.01M12 21a9 9 0 110-18 9 9 0 010 18z" />
  </svg>
);

export const FlagIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 21v-2a4 4 0 014-4h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1zm1-12a4 4 0 014-4h10a1 1 0 011 1v6a1 1 0 01-1 1H8a4 4 0 01-4-4V9z" />
    </svg>
);
